...
//QUERYS
//Variables:
$selectWhat = "count('open') as resultado";
$where_cond ="szStatus = 'open'and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$fuulquery= "select $selectWhat from WebTickets where $where_cond";
...
////****END NEW QUERYES**/////
//OPEN CASES TOTAL
$sql1= "select count('Open') as resultado from WebTickets where szStatus = 'open'and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
if(($result=odbc_exec($con,$sql1))=== false )		//Run query and validate.
  die("Query error." .odbc_errormsg($sql1));		//Run query and validate.
{
  $row = odbc_fetch_array($result);
  $cantopen = $row['resultado'];
}
//CLOSED CASES TOTAL
$sql2= "select count('Closed') as resultado from WebTickets where szStatus = 'Closed'";
...
//MyOpen CASES
$sql3= "select count('Open') as resultado from WebTickets where szStatus = 'Open' and szResponsible = '".$_SESSION['logedas']."' and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$sql4= "select count('Open') as resultado from WebTickets where szStatus = 'open' and szTeam = 'MAP' and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$sql5= "select count('Open') as resultado from WebTickets where szStatus = 'open' and szTeam = 'GT1' and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$sql6= "select count('Open') as resultado from WebTickets where szStatus = 'open' and szTeam = 'BPC' and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$sql7= "select count('Open') as resultado from WebTickets where szStatus = 'open' and szTeam = 'BSI' and mnTicketNumber not in (select mnTicketNumber from WebTickets where szStatus = 'close')";
...
$sql8= "select count('Closed') as resultado from WebTickets where szStatus = 'Close' and szTeam = 'MAP' ";
...
$sql9= "select count('Closed') as resultado from WebTickets where szStatus = 'Close' and szTeam = 'GT1' ";
...
$sql10= "select count('Closed') as resultado from WebTickets where szStatus = 'Close' and szTeam = 'BPC' ";
...
$sql10= "select count('Closed') as resultado from WebTickets where szStatus = 'Close' and szTeam = 'BSI' ";
if(($result10=odbc_exec($con,$sql10))=== false )		//Run query and validate.
  die("Query error." .odbc_errormsg($sql10));		//Run query and validate.
{
  $row = odbc_fetch_array($result10);
...
$sqlt201= "select count('open') as resultado from WebTickets where szStatus = 'open' and szTeam = '$teamoption' ";
...
<?php
 echo "<center>";
  ...
  echo "</center> <br> <br>";
  echo "<center> $cantopentest </center>"
?>
<!-- Tables! -->
